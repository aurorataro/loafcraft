...
onEvent('item.tooltip', e => {
  ...
  e.addAdvanced('createastral:radiant_sword', (item, advanced, text) => {
    ...
    if (e.isShift()) {
      ...
      text.add(1, [Text.of('Has become brittle in the infusion, but is a perfect catalyst for souls and enchantments. Repairs inside of soul fire.').gold(),])
