...
onEvent('recipes', event => {
  ...
  event.replaceInput({output: 'ad_astra:rocket_nose_cone'}, 'ad_astra:compressed_steel', 'ad_astra:iron_plate')
	...
	event.replaceInput({output: 'automobility:automobile_engine'}, 'minecraft:furnace', 'createastral:navigation_mechanism')
...
event.recipes.createFilling('create:large_cogwheel', [
  ...
  {fluid: 'tconstruct:molten_bronze', amount: 3500},
	...
	event.recipes.createMixing(Fluid.of('tconstruct:molten_steel', 18000), [
   {fluid: 'tconstruct:molten_iron', amount: 32400},
   '3x indrev:coal_dust',
...
event.recipes.createMechanicalCrafting('scout:upgraded_pouch', [
  ...
  E: 'minecraft:obsidian'
	...
	event.recipes.createSequencedAssembly([ // begin
		...
		], 'createastral:brass_helmet', [ // input
	...
	event.recipes.createSequencedAssembly([ // begin
		...
		], 'createastral:brass_chestplate', [ // input
	...
	event.recipes.createSequencedAssembly([ // begin
		...
		], 'createastral:brass_leggings', [ // input
	...
	event.recipes.createSequencedAssembly([ // begin
		...
		], 'createastral:brass_boots', [ // input
...
], 'createastral:brass_pickaxe', [ // input
...
], 'createastral:brass_shovel', [ // input
...
], 'createastral:brass_sword', [ // input
...
event.recipes.createFilling('structures_compass:structures_compass', [
  ...
  D: 'createastral:blazing_mechanism',
...
event.recipes.createSequencedAssembly([ // start the recipe
        'minecraft:name_tag', // have this item be a guaranteed output
		], 'minecraft:string', [ // 'create:brass_ingot' is the input.
		event.recipes.createDeploying('farmersdelight:canvas', ['farmersdelight:canvas', 'farmersdelight:canvas']),
		event.recipes.createDeploying('farmersdelight:canvas', ['minecraft:paper', 'minecraft:paper']),
        event.recipes.createDeploying('farmersdelight:canvas', ['minecraft:ink_sac', 'minecraft:ink_sac']),
    ]).transitionalItem('farmersdelight:canvas').loops(3)
	...
	event.recipes.createSequencedAssembly([ // start the recipe
        ...
        event.recipes.createDeploying('create:incomplete_precision_mechanism', ['ad_astra:steel_nugget', 'ad_astra:steel_nugget']), //fill bronze
    ]).transitionalItem('create:incomplete_precision_mechanism').loops(25)
  ...
  'create:iron_sheet',
	...
	event.recipes.createMixing('ad_astra:steel_ingot', [
   '4x minecraft:iron_ingot',
   '3x indrev:coal_dust',
 ]).superheated().processingTime(5000)
 

 event.recipes.createCrushing([
  Item.of('3x minecraft:porkchop').withChance(1),
  Item.of('tconstruct:blood_block').withChance(1),
  Item.of('5x create:experience_nugget').withChance(0.5)
], 'yippee:tbh')
...
event.recipes.createMechanicalCrafting('ad_astra:jet_suit', [
  ...
  E: 'ad_astra:netherite_space_suit',
...
event.recipes.createMechanicalCrafting('ad_astra:jet_suit_helmet', [
  ...
  A: 'ad_astra:compressed_calorite',
  E: 'ad_astra:netherite_space_helmet',
  F: 'create:electron_tube',
...
event.recipes.createMechanicalCrafting('ad_astra:jet_suit_pants', [
  ...
  A: 'ad_astra:compressed_calorite',
  C: 'ad_astra:calorite_block',
  E: 'ad_astra:netherite_space_pants',
  F: 'dustrial_decor:padded_block',
...
event.recipes.createMechanicalCrafting('ad_astra:jet_suit_boots', [
  ...
  A: 'ad_astra:compressed_calorite',
  C: 'ad_astra:calorite_block',
  E: 'ad_astra:netherite_space_boots',
  F: 'dustrial_decor:padded_block',
